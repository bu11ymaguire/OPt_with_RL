...
a project decision about resource commitment. Merging them would force us to defend
gate thresholds as if they were scholarly boundaries.

\subsection{Scientific conclusion}
\label{sec:scientific-conclusion}

This subsection states results only. It does not mention policy learning or project
decisions.
...
We do not claim these thresholds are correct. We claim only that they were fixed
before the results were seen and were not changed afterwards.
