...
\begin{description}
  ...
  \item[E12] The protocol specified that a tag be created at the
    configuration-freeze point. That tag was never created, so the freeze cannot be
    verified by a tag-based diff. The frozen decisions are recorded in the protocol
    document, and we did not create the tag retroactively.
\end{description}
